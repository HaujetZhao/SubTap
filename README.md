...
SubTap 想换一种方式：**主动点读**。每一句都要你主动点一下才会读，句与句之间留出充足的思考时间；遇到生词、难句，旁边就有释义。把"被动听"变成"主动读、主动听"，让注意力始终在线。
...
任何你喜欢的音视频都能拿来当学习材料——美剧、演讲、YouTuber 的视频，从网上下载到本地即可。字幕有两种途径：

- **下载现成字幕**：从字幕站、YouTube 等获取对应的 SRT / VTT 等文件。
- **自己转录**：用同属作者开发的 [CapsWriter-Offline](https://github.com/HaujetZhao/CapsWriter-Offline)，离线转录出高质量、带时间戳的字幕文件。
